...
- [Roadmap](/katachi/roadmap/) ... Check which version will bring the documentation generation and Gradle plugin that are planned to sit on top of this mechanism.
