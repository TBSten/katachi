...
導入手順や書き方は [初めてのアーキテクチャ定義](/katachi/get-started/first-architecture/) を参照してください。
...
**baseline 機能として予定していますが、まだ実装されていません**（[ロードマップ](/katachi/roadmap/)）。
...
同じ定義から自分で何かを取り出すこともできます（[ArchitectureProcessor とそのカスタマイズ](/katachi/guides/processor/)）。

<Aside type="caution">
ドキュメント生成は **v0.3 で予定している機能で、まだ動きません。**
