...
For how to install it and how to write definitions, see [Your first architecture definition](/katachi/en/get-started/first-architecture/).
...
([Roadmap](/katachi/en/roadmap/)). For now, you can take the list of violations via `process()`
...
<CardGrid>
  <LinkCard
    ...
    href="/katachi/en/guides/konsist-integration/"
  />
  <LinkCard
    title="Comparison with other tools"
    description="How detekt, Konture, and the rest — the tools that check contents — relate to katachi."
    href="/katachi/en/get-started/comparison-with-other-tools/"
  />
</CardGrid>
...
([ArchitectureProcessor and customizing it](/katachi/en/guides/processor/)).

<Aside type="caution">
Documentation generation is **planned for v0.3 and does not work yet.**
