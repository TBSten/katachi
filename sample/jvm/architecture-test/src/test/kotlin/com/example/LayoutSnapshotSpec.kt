 ...
 *
 * Deliberately **outside** `sample/jvm`, because everything inside it is subject to this
...
private val HEADER: List<String> = listOf(
    ...
    "# 生成元: sample/jvm の LayoutSnapshotSpec (projectArchitecture.flattenLayout() の結果)",
    "# 更新: cd sample/jvm && ./gradlew :architecture-test:test --rerun -D$UPDATE_PROPERTY=true",
...
/**
 * `sample/layout-snapshots/jvm.txt`, located through katachi's own project-root detection.
 *
