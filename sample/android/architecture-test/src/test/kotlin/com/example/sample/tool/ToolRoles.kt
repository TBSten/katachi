...
/**
 * Roles of the tools a repository carries that are neither the app nor its build: git for
 * now, and whatever else earns a place later (CI, formatters, editor settings).
 *
